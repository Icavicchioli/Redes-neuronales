...
\subsubsection{Clonado de controlador}


1. agarro y armo pid -> SS -> pid tuner -> ajuste fiuno en simulink -> comparo como andan ante perturbaciones y como siguen la referencia.

El controlador PID fue sintonizado utilizando el PID Tuner de MATLAB sobre el modelo linealizado continuo de la planta. Posteriormente, el controlador continuo fue discretizado mediante transformación bilineal para su implementación en Simulink, donde fue evaluado sobre el modelo no lineal completo.”
...
luego de tener este lo ajusté con la red neuronal a 1.8 0.005 0 20

luego se reemplazó la NN por la planta no lineal y anduvo bien, lo que ya nos imaginabamos porque eran sistemas que ajustaban bien, pero tmb responden igual a control. asi que genial
