...
\begin{figure}[h!]
	...
	\caption{ECM de entrenamiento y validación - Minibatch de 40 muestras}
...
\begin{figure}[h!]
	...
	\caption{Predicción del modelo en base a (X,Y,Z) - Minibatch de 40 muestras}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{imgs/batch1ECM}
	\caption{ECM de entrenamiento y validación - Minibatch de 1 muestra}
	\label{fig:batch1ecm}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{imgs/batch1AjusteFuncion}
	\caption{Predicción del modelo en base a (X,Y,Z) - Minibatch de 1 muestra}
	\label{fig:batch1ajustefuncion}
\end{figure}
