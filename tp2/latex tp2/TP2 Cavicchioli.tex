...
\title{Trabajo práctico 2\\ Redes Neuronales y Aprendizaje Profundo}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{imgs/batch40y40muestras_noConverge1}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{imgs/batch40y40muestras_Converge}
	\caption{}
...
La MRB se puede pensar como una red \textit{feedfoward} de 4 capas, en vez de pensarla como una de 2 capas con pesos simétricos. $v$ es la capa visible y $h$ es la oculta, y tenemos un $\hat{v}$ y $\hat{h}$, que son las estimaciones.
...
Las figuras \ref{fig:ej5ecm400} y \ref{fig:ej5reconst400} muestran el ECM de reconstrucción y reconstrucciones para 400 neuronas en la capa más chica (también denominada intermedia). A modo de referencia, las imágenes de MNISTS son de 28x28, por lo que la capa de entrada es de 784.

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_ecm400}
	\caption{ECM  de reconstrucción - 400 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej5ecm400}
\end{figure}
...
\begin{figure}[h!]
	\vspace{-1cm}
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_reconst400}
	\caption{Reconstrucciones - 400 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej5reconst400}
\end{figure}

\clearpage

Las figuras \ref{fig:ej5ecm200} y \ref{fig:ej5recons200} muestran el ECM de reconstrucción y reconstrucciones para 200 neuronas en la capa más chica.

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_ecm200}
	\caption{ECM  de reconstrucción - 200 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej5ecm200}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_recons200}
	\caption{Reconstrucciones - 200 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej5recons200}
\end{figure}
\clearpage

Las figuras \ref{fig:ej5ecm100} y \ref{fig:ej5recons100} muestran el ECM de reconstrucción y reconstrucciones para 100 neuronas en la capa más chica.

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_ecm100}
	\caption{ECM  de reconstrucción - 100 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej5ecm100}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_recons100}
	\caption{Reconstrucciones - 100 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej5recons100}
\end{figure}
\clearpage

Las figuras \ref{fig:ej550} y \ref{fig:ej551} muestran el ECM de reconstrucción y reconstrucciones para 50 neuronas en la capa más chica.

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_50}
	\caption{ECM  de reconstrucción - 50 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej550}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_51}
	\caption{Reconstrucciones - 50 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej551}
\end{figure}
\clearpage
Las figuras \ref{fig:ej510} y \ref{fig:ej511} muestran el ECM de reconstrucción y reconstrucciones para 10 neuronas en la capa más chica.

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_10}
	\caption{ECM  de reconstrucción - 10 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej510}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_11}
	\caption{Reconstrucciones - 10 neuronas en capa intermedia de menor tamaño}
	\label{fig:ej511}
\end{figure}
\clearpage
Las figuras \ref{fig:ej51} y \ref{fig:ej52} muestran el ECM de reconstrucción y reconstrucciones para 1 neurona en la capa más chica.

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_1}
	\caption{ECM  de reconstrucción - 1 neurona en capa intermedia de menor tamaño}
	\label{fig:ej51}
\end{figure}

\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej5_2}
	\caption{Reconstrucciones - 1 neurona en capa intermedia de menor tamaño}
	\label{fig:ej52}
\end{figure}
...
\begin{itemize}
	\item A medida que se achica la capa intermedia , las reconstrucciones se vuelven menos claras y similares al dígito original. En el extremo, la de 1 sola neurona reconstruye siempre la misma imagen.
	\item El ECM de reconstrucción aumenta a medida que se sacan neuronas de la capa intermedia.
\end{itemize}

Estos efectos observados tienen sentido, y suceden con PCA, que sería el método de reducción de dimensionalidad lineal. En este, cuando se quitan direcciones principales, se pierde información/energía/varianza de los datos de entrada, y para el caso de mantener solo la dirección de mayor varianza, el sistema siempre va a devolver el patrón más común a todos los datos, perdiéndose todo el detalle quye estaba en las direcciones de menos varianza.
...
Para este ejercicio se fueron generando modelos de CNN y de MLP cada vez más pequeños que lleguen al 90\% de \textit{accuracy} de testeo/evaluación.

\subsubsection{CNNs}

La Figura~\ref{fig:ej61} muestra la evolución de la pérdida de entrenamiento, la pérdida de validación y la precisión obtenida para la red neuronal convolucional.
Esta red posee una capa convolucional que recibe un plano de entrada y genera 8 planos de salida, utilizando kernels de tamaño $5 \times 5$.
Luego se aplica una capa de pooling con ventana de $2 \times 2$, que reduce a la mitad la resolución espacial, seguida de una capa completamente con 10 salidas.
El modelo cuenta con 11,738 parámetros entrenables.
Tras 15 épocas de entrenamiento se alcanzó una precisión del 98.46\%.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{imgs/ej6_1}
	\caption{Evolución del error y precisión para la CNN N°1.}
	\label{fig:ej61}
\end{figure}

\newpage

La Figura~\ref{fig:ej62} corresponde a la segunda CNN entrenada, que posee una capa convolucional con un plano de entrada y 5 planos de salida, con kernels de tamaño $5 \times 5$.
A continuación se aplica una operación de pooling con ventana de $2 \times 2$ y una capa completamente conectada de 10 salidas.
El modelo tiene un total de 7,340 parámetros entrenables.
Luego de 17 épocas, alcanzó una precisión del 98.10\%.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{imgs/ej6_2}
	\caption{Evolución del error y precisión para la CNN N°2.}
	\label{fig:ej62}
\end{figure}

La Figura~\ref{fig:ej63} muestra los resultados de la CNN número 3, compuesta por una capa convolucional que recibe un plano de entrada y produce 2 planos de salida mediante kernels de $5 \times 5$.
Luego se aplica pooling con ventana de $2 \times 2$, y finalmente una capa lineal de 10 salidas.
El modelo cuenta con 2,942 parámetros entrenables.
Tras 30 épocas de entrenamiento, alcanzó una precisión del 97.01\%.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{imgs/ej6_3}
	\caption{Evolución del error y precisión para la CNN N°3.}
	\label{fig:ej63}
\end{figure}

\newpage

La Figura~\ref{fig:ej64} presenta la cuarta CNN ideada, conformada por una capa convolucional con un plano de entrada y 2 planos de salida, con kernels de tamaño $9 \times 9$.
Se aplica luego una capa de pooling de $2 \times 2$, seguida de una capa totalmente conectada de 10 salidas.
El modelo tiene 2,174 parámetros entrenables.
Tras 23 épocas, obtuvo una precisión del 97.09\%.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{imgs/ej6_4}
	\caption{Evolución del error y precisión para la CNN N°4.}
	\label{fig:ej64}
\end{figure}

La Figura~\ref{fig:ej65} corresponde a la CNN N°5, compuesta por una capa convolucional que recibe un plano de entrada y genera 2 planos de salida utilizando kernels de $15 \times 15$.
Luego se aplica pooling con ventana de $2 \times 2$ y una capa lineal con 10 salidas.
La red posee 1,442 parámetros entrenables.
Tras 23 épocas, alcanzó una precisión del 95.32\%.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{imgs/ej6_5}
	\caption{Evolución del error y precisión para la CNN N°5.}
	\label{fig:ej65}
\end{figure}

\newpage

Finalmente, la Figura~\ref{fig:ej66} muestra los resultados de la CNN más chica.
Esta red posee una capa convolucional que recibe un plano de entrada y genera 2 planos de salida con kernels de $15 \times 15$, seguida de una operación de pooling con ventana de $4 \times 4$ y una capa completamente conectada con 18 entradas y 10 salidas.
El modelo tiene 642 parámetros entrenables.
Tras 30 épocas, se obtuvo una precisión del 91.58\%.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{imgs/ej6_6}
	\caption{Evolución del error y precisión para la CNN N°6.}
	\label{fig:ej66}
\end{figure}
...
La Figura~\ref{fig:ej67} corresponde al MLP N°1, compuesto por dos capas lineales: una primera capa con 784 entradas y 64 salidas, y una segunda capa con 10 salidas.
La red posee 50,890 parámetros entrenables.
Tras 15 épocas, alcanzó una precisión del 97.36\%.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{imgs/ej6_7}
	\caption{Evolución del error y precisión para el MLP1.}
	\label{fig:ej67}
\end{figure}

\newpage

La Figura~\ref{fig:ej68} presenta al MLP N°2, conformado por una única capa lineal con 784 entradas y 10 salidas.
El modelo cuenta con 7,850 parámetros entrenables.
Tras 18 épocas de entrenamiento, alcanzó una precisión del 92.86\%.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{imgs/ej6_8}
	\caption{Evolución del error y precisión para el MLP2.}
	\label{fig:ej68}
\end{figure}

La Figura~\ref{fig:ej69} muestra los resultados del MLP N°3, compuesto por una operación de \textit{max-pooling} con ventana de $2 \times 2$, seguida de una capa lineal con 196 entradas y 10 salidas.
El modelo tiene 1,970 parámetros entrenables.
Tras 30 épocas, alcanzó una precisión del 92.17\%.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.9\linewidth]{imgs/ej6_9}
	\caption{Evolución del error y precisión para el MLP3.}
	\label{fig:ej69}
\end{figure}
...
Todos los gráficos se ven razonables: los errores disminuyen con las iteraciones y el \textit{accuracy} tiende a subir. A veces el ECM de testeo/evaluación queda por debajo del de entrenamiento, que puede deberse a las imágenes del dataset de testeo. Se usó la proporción de train/test de 60000/10000 ($\sim$ 83/17) propia de MNIST, con \textit{minibatches} de tamaño 64 (que aporta los beneficios ya mencionados en la consigna sobre el tema). Se usó la función de activación ReLu.

La CNN más chica encontrada es de 642 parámetros, y hace gran uso del pooling para disminuir fuertemente la dimensión de la capa lineal ``\textit{fully connected}'' que nos da las 10 salidas (1 por dígito).
...
Es claro que el modelo con la capa convolucional es más eficiente en términos de cantidad de parámetros (son menos). La capa convolucional no solo es ``barata'' en términos de parámetros, sino que además permite hacer \textit{feature extraction} local, es decir, sin perder la posición de la \textit{feature}, y aparte aprende que características extaer para minimizar el error en la predicción/categorización. Esto último es crucial ya que evita tener que pensar de antemano que propiedades se deben extraer de lo que se desea clasificar, se deja en ``manos'' de la máquina para que lo aprenda. Ahora si, es posible que sea imposible para un humano entender que termina extrayendo cada plano de convolución \footnote{Algo así como cuando se obtiene una matriz para una representación de un sistema en espacio de estados. Es posible que la representación no esté dada en base a estados comprensibles (como velocidad, espacio, altura, etc.), sino que una mezcla indistinguible de ellos}.
...
Primero se entrenó un \textit{autoencoder} como los vistos en clase (pero sin hacer el proceso con las MRB). La finalidad es poder quedarse con la etapa de codificación, de \textit{encoder}, que implicitamente ejecuta la función que transforma datos del dominio de la entrada al espacio de menor dimensión. Para este caso se eligió una reducción del 80\% de la dimensión hecho en 4 etapas: Se inició con una capa de 784 neuronas, que alimenta una de 392 y al final hay una de 156, una redución de $5$ la dimensión de entrada. La función de activación es la ReLu y se usó en conjunto con ``Adam''. El entrenamiento del \textit{autoencoder} fue no supervisado, solo requiere de los $X$, no de las \textit{labels}.

La imagen \ref{fig:ej71} muestra la \textit{loss} de entrenamiento y validación. Se observa convergencia. La figura \ref{fig:ej72} muestra los datos de entrada (los dígitos originales) y salida (reconstruidos) del \textit{autoencoder}. Hay diferencias muy sutiles en la intensidad de los tonos. El \textit{autoencoder} tomó $\sim \SI{8}{\min}$ en entrenarse.

\begin{figure}[!h]
	\centering
	\includegraphics[width=0.8\linewidth]{imgs/ej7_1}
	\caption{\textit{Loss} de entrenamiento y testeo.}
	\label{fig:ej71}
\end{figure}

\begin{figure}[!h]
	\centering
	\includegraphics[width=1\linewidth]{imgs/ej7_2}
	\caption{Dígitos originales y sus respectivas reconstrucciones.}
	\label{fig:ej72}
\end{figure}
...
Una vez entrenado el \textit{autoencoder}, se extrajo el \textit{encoder}, se congelaron sus pesos y se le acopló un MLP que pasa de esas 156 neuronas a 10. Una vez entrenada, esta etapa hizo la categorización de los dígitos de MNIST. EL entrenamiento de esta parte fue supervisado ya que requirió de las \textit{labels} de las imágenes. El categorizador se entrenó por 100 epochs, y llegó a los resultados del cuadro \ref{tab:accuracy_por_digito}. El entrenamiento tomó  $\sim \SI{6}{\min}$ y $\SI{40}{\second}$

\begin{table}[!h]
	\centering
	\caption{Precisión por dígito en el conjunto de prueba.}
	\begin{tabular}{c c c}
		\hline
		\textbf{Dígito} & \textbf{Accuracy [\%]} & \textbf{Cantidad de muestras} \\
		\hline
		0 & 97.04 & 980 \\
		1 & 97.97 & 1135 \\
		2 & 90.50 & 1032 \\
		...
		9 & 92.77 & 1009 \\
		\hline
		\textbf{Promedio} & \textbf{91.92} & -- \\
		\textbf{Global} & \textbf{92.09} & \textbf{10,000} \\
		\hline
	\end{tabular}
	\label{tab:accuracy_por_digito}
\end{table}

Para comparar, se creó un MLP que pasa de la imagen de MNIST (tamaño 784) a 10 (la salida). La performance se ve en el cuadro \ref{tab:accuracy_por_digito2} y el entrenamiento tomó  $\sim \SI{7}{\min}$.

\begin{table}[h!]
	\centering
	\caption{Accuracy por dígito en el conjunto de prueba}
	\begin{tabular}{c c c}
		\hline
		\textbf{Dígito} & \textbf{Accuracy (\%)} & \textbf{Cantidad de muestras} \\
		\hline
		...
		9 & 92.57 & 1009 \\
		\hline
		\textbf{Promedio} & \textbf{92.64} & -- \\
		\textbf{Global} & \textbf{92.73} & \textbf{10000} \\
		\hline
	\end{tabular}
	\label{tab:accuracy_por_digito2}
\end{table}

\newpage
También se probó con una red que usa el encoder pero no congela esas capas, sino que permite hacer cierto \textit{fien-tuning} y otra con más capas ocultas en el MLP post \textit{encoder}.

La red con \textit{encoder} \textit{fine-tuned} tardó $SI{}{\min}$ y logró los resultados del cuadro \ref{tab:accuracy_por_digito_encoder_fine_tuned}.

\begin{table}[h!]
	\centering
	\caption{Accuracy por dígito en el conjunto de prueba (\textit{encoder} con \textit{fine-tuning}).}
	\begin{tabular}{c c c}
		\hline
		\textbf{Dígito} & \textbf{Accuracy (\%)} & \textbf{Cantidad de muestras} \\
		\hline
		...
		9 & 90.49 & 1009 \\
		\hline
		\textbf{Promedio} & \textbf{92.23} & -- \\
		\textbf{Global} & \textbf{92.35} & \textbf{10000} \\
		\hline
	\end{tabular}
	\label{tab:accuracy_por_digito_encoder_fine_tuned}
\end{table}



La red con otra capa oculta más y  \textit{encoder} congelado demoró $SI{7}{\min}$ con \SI{30}{\sec}, y llegó a los resultados del cuadro \ref{tab:accuracy_por_digito_encoder_fc156}.

\begin{table}[h!]
	\centering
	\caption{Accuracy por dígito en el conjunto de prueba (\textit{encoder} + FC intermedia}
	\begin{tabular}{c c c}
		\hline
		\textbf{Dígito} & \textbf{Accuracy (\%)} & \textbf{Cantidad de muestras} \\
		\hline
		...
		9 & 96.13 & 1009 \\
		\hline
		\textbf{Promedio} & \textbf{97.90} & -- \\
		\textbf{Global} & \textbf{97.94} & \textbf{10000} \\
		\hline
	\end{tabular}
	\label{tab:accuracy_por_digito_encoder_fc156}
\end{table}

\newpage
\subsection{Análisis}

Los resultados obtenidos indican que el uso del \textit{autoencoder} permitió hacerla reducción de dimensionalidad del 80\% que se buscaba, conservando gran parte de la información de la entrada. Sin embargo, esta reducción de dimensionalidad no garantizó la performance en los otros modelos.

El primer modelo (\textit{encoder} congelado y 1 MLP de 156 a 10) alcanzó un \textit{accuracy} global de 92.09\%, valor comparable pero ligeramente inferior al obtenido por el MLP entrenado directamente sobre las imágenes originales (92.73\%). Esto sugiere que, si bien el \textit{encoder} logra una buena compresión, falta algo más para lograr igualar las performances.

Cuando se permitió el \textit{fine-tuning} del encoder (es decir, ajustar parcialmente los pesos del encoder durante el entrenamiento del clasificador), el rendimiento mejoró levemente, alcanzando un \textit{accuracy} global de 92.35\%. Esto indica que un ligero ajuste a los pesos del \textit{encoder} ayuda a recuperar parte de la información perdida, o por lo menos llevar las representaciones a formas que hacen más exacta la clasificación.

Por otro lado, al agregar una capa oculta adicional de 156 neuronas (encoder congelado + FC intermedia 156$\to$156$\to$10), el desempeño aumentó notablemente, alcanzando una exactitud global de 97.94\%. Este resultado evidencia que, si bien la representación comprimida limita la información disponible, una arquitectura más elaborada permite explotar la información que sí está, que al fin y al cabo es la que representa más los datos originales en el espacio latente de menor dimensión.

En cuanto al tiempo de entrenamiento, si se considera únicamente la etapa de clasificación, los modelos basados en el encoder son más rápidos debido a la menor dimensionalidad de entrada (156 frente a 784). Sin embargo, al sumar el tiempo de entrenamiento previo del \textit{autoencoder} ($\sim$8 min), el proceso completo resulta más costoso en términos computacionales que entrenar un MLP directamente sobre los datos originales.

En conclusión, el uso del \textit{encoder} puede ser beneficioso para reducir la dimensionalidad de los datos y acelerar el aprendizaje de etapas posteriores, pero en este caso, un MLP entrenado sobre la imagen de forma directa logra resultados equivalentes con menor complejidad arquitectónica.
La combinación de \textit{encoder} y clasificador más profundo (156$\to$156$\to$10) mostró ser la alternativa más efectiva y exacta dentro de los modelos derivados del \textit{autoencoder}.


Una pregunta interesante para seguir con este tema sería investigar que es más rápido cuando se habla de ejecución en tiempo real. Un sistema como el MLP que va de 784 a 10 tiene muchas conexiones, y podría tomar más tiempo en ejecutarse que hacer la codificación de la imagen con el \textit{encoder} y luego ejecutar un MLP de menor complejidad.
...
Para este ejercicio se reusó el código del ejercicio 3, cambiando la regla de aprendizaje a aquella del \textit{simulated annealing}\footnote{Emula el proceso físico de templar y revenir una pieza de metal}.

El algoritmo inicia con un set de pesos $w$, actualizados como $w(n+1)=w(n) + \mathcal{N}(0, \sigma ^2 )$. Es decir, el paso, o $\delta w$ es aleatorio, y la varianza de la gaussiana determina que tan grande es ese paso. Luego de obtener un set de parámetros $w(n+1)$, se calcula el $\delta E = E(w(n+1)) - E(w(n))$, que es lo mismo que decir que se calcula el cambio del error después del cambio de parámetros.

Ahora viene lo interesante: si el error decrece ($\delta E < 0$) entonces se admite el cambio de parámetros y $w(n) = w(n+1)$. En cambio, si el error empeora ($\delta E > 0$), el cambio se admite con una probabilidad $e ^\frac{-\delta E}{T}$, siendo $T$ la temperatura del sistema en ese instante.

Como detalle final, la temperatura se debe decrecer para que el algoritmo vaya convergiendo (si es muy alta tal vez pasea por el espacio de estados sin límite). Esto generalmente se hace de forma exponencial como $T(n+1) = \alpha T(n)$. En el desarrollo hecho se usó un decaimiento de temperatura del tiempo exponencial y un $\sigma$ constante. A continuación se detallan los varios casos simulados.
...
\begin{figure}[h!]
	...
	\caption{Frontera de decisión de MLP con 2 neuronas en la capa oculta}
...
\begin{figure}[h!]
	...
	\caption{ECM y temperatura por iteración para MLP con 2 neuronas en la capa oculta}
	\label{fig:screenshot002}
\end{figure}

La red con dos neuronas ocultas logró aprender perfectamente la XOR de dos entradas, igual que en la consigna 3. En la figura~\ref{fig:screenshot001} se observa una frontera de decisión con forma similar a la obtenida mediante gradiente descendente. En la figura~\ref{fig:screenshot002} se muestra la evolución del ECM y la temperatura: el error presenta cierta variabilidad debido a la naturaleza estocástica del método, pero termina convergiendo a cero. El decaimiento fue de $\alpha = 0.995$.
...
\begin{figure}[h!]
	...
	\caption{Frontera de decisión de MLP con 4 neuronas en la capa oculta}
...
\begin{figure}[h!]
	...
	\caption{ECM y temperatura por iteración para MLP con 4 neuronas en la capa oculta}
	\label{fig:screenshot004}
\end{figure}

La figura~\ref{fig:screenshot003} muestra la frontera de decisión obtenida, mientras que la figura~\ref{fig:screenshot004} presenta la evolución del ECM. En este caso la red también resolvió la XOR correctamente: el error decrece de forma sostenida y la frontera se ajusta a lo esperado. El decaimiento fue de $\alpha = 0.995$.
...
\begin{figure}[h!]
	...
	\caption{Frontera de decisión de MLP con 10 neuronas en la capa oculta}
...
\begin{figure}[h!]
	...
	\caption{ECM y temperatura por iteración para MLP con 10 neuronas en la capa oculta}
	\label{fig:screenshot006}
\end{figure}

En la figura~\ref{fig:screenshot005} se observa una frontera de decisión más curva y compleja, coherente con el mayor número de neuronas ocultas. El error medio (figura~\ref{fig:screenshot006}) desciende de forma estable, mostrando que el método sigue funcionando correctamente incluso con una red más grande. El decaimiento fue de $\alpha = 0.995$.

\newpage

\subsubsection{XOR de 2 entradas - 2 neuronas en capa oculta - decaimiento rápido}


\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{../imgs/ej8/screenshot007}
	\caption{ECM y temperatura - decay rate $\alpha = 0.98$ (caso 1)}
...
\begin{figure}[h!]
	...
	\caption{ECM y temperatura - decay rate $\alpha = 0.98$ (caso 2)}
	\label{fig:screenshot008}
\end{figure}

Con un decaimiento de temperatura más rápido ($\alpha = 0.98$), el comportamiento fue más variable: en algunos casos (figura~\ref{fig:screenshot007}) la red alcanzó una buena solución, mientras que en otros (figura~\ref{fig:screenshot008}) no logró converger. Esto muestra la fuerte influencia del azar en este tipo de entrenamiento estocástico.

\newpage

\subsubsection{XOR de 2 entradas - 2 neuronas en capa oculta - decaimiento lento }


\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{../imgs/ej8/screenshot009}
	\caption{ECM y temperatura - decay rate $\alpha = 0.999$ (caso 1)}
...
\begin{figure}[h!]
	...
	\caption{ECM y temperatura - decay rate $\alpha = 0.999$ (caso 2)}
	\label{fig:screenshot010}
\end{figure}

Con un decaimiento más lento ($\alpha = 0.999$), la temperatura se mantuvo alta durante gran parte del proceso. Como consecuencia, la red no logró estabilizarse y quedó atrapada en mínimos no globales (figuras~\ref{fig:screenshot009} y \ref{fig:screenshot010}). Este resultado se repitió en varias ejecuciones, aunque no puede considerarse definitivo debido a la aleatoriedad del método.
...
\begin{figure}[h!]
	...
	\caption{Frontera de decisión o error para MLP con 4 neuronas ocultas (4 entradas)}
	\label{fig:screenshot011}
\end{figure}

En este caso la red no logró aprender la XOR de 4 entradas. El error se mantuvo elevado y no se observó convergencia clara.
...
\begin{figure}[h!]
	...
	\caption{Resultados de MLP con 5 neuronas ocultas (4 entradas)}
	\label{fig:screenshot012}
\end{figure}

Al aumentar a cinco neuronas en la capa oculta, la red sí consiguió aprender la XOR de 4 entradas, mostrando una reducción progresiva del error.
...
\begin{figure}[h!]
	...
	\caption{Resultados de MLP con 6 neuronas ocultas (4 entradas)}
	\label{fig:screenshot013}
\end{figure}

La red fue  capaz de aprender completamente la XOR de 4 entradas. Además, el ECM de aprendizaje se ve más estable que para las otras configuraciones de menos neuronas.


\subsection{Análisis}

Las redes no tuvieron problema en aprender la XOR de 2 entradas, tal como se observó en la tercer consigna de este documento. Se notó que el factor de decaimiento de la temperatura es crítico para la convergencia, y un factor muy lento o rápido puede causar que no se aprenda.

Un dato a destacar es que el aprendizaje por \textit{simulated annealing} permitió que un MLP de 6 neuronas en la capa oculta aprendiese la XOR de 4 entradas, cuando se había requerido uno de 10 cuando se usó gradiente descendiente (su versión básica). Esto puede deberse a que el espacio de soluciones se amplía\footnote{Es la forma mental en la que concibo como cambian los espacios por donde se mueve el vector de estados de los parámetros del sistema. Parecería que cambiar como se aprende, afecta las cuencas tal que se vuelven más profundas/accesibles/atractivas, resultando en mejores resultados.}, facilitando que el método encuentre una combinación de pesos que satisfaga todas las condiciones de la XOR.
