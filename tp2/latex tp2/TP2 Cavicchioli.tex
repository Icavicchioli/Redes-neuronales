...
\subsubsection{Minibatch de 40 muestras}

Las figuras \ref{fig:batch40ecm} y \ref{fig:batch40ajustefuncion} corresponden a un minibatch de 40 muestras. Se nota convergencia en los ECM y una predicción que empeora en los valores más extremos de la variable a predecir.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{imgs/batch40ECM}
	\caption{ECM de entrenamiento y validación - Minibatch de 40 muestras, 10 veces, 1 epoch}
...
\begin{figure}[h!]
	...
	\caption{Predicción del modelo en base a (X,Y,Z) - Minibatch de 40 muestras, 10 veces, 1 epoch}
...
\subsubsection{Minibatch de 100 muestras}

Las figuras \ref{fig:batch100ecm} y \ref{fig:batch100ajustefuncion} corresponden a un minibatch de 100 muestras. Los ECM convergen pero la predicción es peor que las anteriores.
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{imgs/batch100ECM}
	\caption{ECM de entrenamiento y validación - Minibatch de 100 muestras}
...
\begin{figure}[h!]
	...
	\caption{Predicción del modelo en base a (X,Y,Z) - Minibatch de 100 muestras}
	\label{fig:batch100ajustefuncion}
\end{figure}


\subsubsection{Minibatch de 1000 muestras}

Las figuras \ref{fig:batch100ecm} y \ref{fig:batch100ajustefuncion} corresponden a un minibatch de 100 muestras. Los ECM parecerían converger, y la predicción es la peor de todas.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{imgs/batch1000ECM1}
	\caption{ECM de entrenamiento y validación - Minibatch de 1000 muestras}
...
\begin{figure}[h!]
	...
	\caption{Predicción del modelo en base a (X,Y,Z) - Minibatch de 1000 muestras}
	\label{fig:batch1000ajustefuncion1}
\end{figure}

\subsubsection{Análisis}

Se observa que un valor menor de minibatch se condiciona con mejores predicciones, aunque esto puede deberse a que para una cantidad fija de iteraciones, el modelo
...
Las figuras \ref{fig:batch40y40muestrasconverge} y \ref{fig:batch40y40muestrasconverge1} son el resultado de tomar el modelo de las imágenes de antes pero darle más iteraciones de aprendizaje. Ahora si se observa convergencia en los EC; y la predicción es más cercana a los valores reales.
...
\subsubsection{Minibatch de 1 muestras}
