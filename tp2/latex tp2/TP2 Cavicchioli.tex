...
La figura \ref{fig:ej5ecm} muestra el error de reconstrucción de las imágenes por época de entrenamiento. El error decrece de forma exponencial con

\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{imgs/ej5_ecm}
	\caption{}
	\label{fig:ej5ecm}
\end{figure}
