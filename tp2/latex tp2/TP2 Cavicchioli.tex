...
La imagen \ref{fig:ej71} muestra la \textit{loss} de entrenamiento y validación. Se observa convergencia. La figura \ref{fig:ej72} muestra los datos de entrada (los dígitos originales) y salida (reconstruidos) del \textit{autoencoder}. Hay diferencias muy sutiles en la intensidad de los tonos.
