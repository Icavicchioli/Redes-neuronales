...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_1.png}
    \caption{Variación de la capacidad de la red neuronal en función de la probabilidad de error}
    \label{fig:ej2_2_1}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_2.png}
    \caption{Variación de la capacidad de la red neuronal en función de la probabilidad de error}
    \label{fig:ej2_2_2}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_3.png}
    \caption{Variación de la capacidad de la red neuronal en función de la probabilidad de error}
    \label{fig:ej2_2_3}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_4.png}
    \caption{Variación de la capacidad de la red neuronal en función de la probabilidad de error}
    \label{fig:ej2_2_4}
\end{figure}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_5.png}
    \caption{Variación de la capacidad de la red neuronal en función de la probabilidad de error}
    \label{fig:ej2_2_5}
\end{figure}
