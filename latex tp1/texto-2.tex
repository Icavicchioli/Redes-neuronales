...
El cuarto y último inciso del primer ejercicio requiere entrenar a una red con todas las imágenes y verificar si fueron aprendidas. La nueva red fue entrenada sobre las imágenes redimensionadas a un tamaño en común, que inicialmente se fijó en $60 \times 60$ . El resultado se puede ver en la figura \ref{fig:ej1_4}. Solo se pudieron aprender 4 de los 6 estados. 

Para verificar esto se entrenó otra red con imágenes de $100 \times 100$
\clearpage
\newpage
