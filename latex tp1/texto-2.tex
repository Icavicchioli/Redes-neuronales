...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.48\linewidth}
        \centering
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_4.png}}\\
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_5.png}}\\
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_6.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.48\linewidth}
        \centering
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_1.png}}\\
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_2.png}}\\
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_3.png}}
    \end{minipage}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.48\linewidth}
        \centering
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_7.png}}\\
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_8.png}}\\
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_9.png}}
    \end{minipage}\hfill
    \begin{minipage}{0.48\linewidth}
        \centering
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_10.png}}\\
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_11.png}}\\
        \subfloat[]{\includegraphics[width=\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej1_4_12.png}}
    \end{minipage}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_1_1.png}
...
El cuadro~\ref{tab:correlaciones} muestra como varía la capacidad en función de la correlación entre patrones y las probabilidades de error. Las figuras 13 a 17 muestran la evolución de la capacidad para cada correlación simulada. 

\begin{table}[h!]
\centering
\begin{tabular}{|c|c|c|c|c|c|}
\hline
$P_{error}$ & $p_{max}/N$ (0.2) & $p_{max}/N$ (0.4) & $p_{max}/N$ (0.6) & $p_{max}/N$ (0.8) & $p_{max}/N$ (1.0) \\ \hline
0.001  &   $0.025$    &    $0.015$   &   $0.01$    &    $0.01$   &   $1$    \\ \hline
0.0036 &    $0.055$   &     $0.015$  &    $0.01$   &  $0.01$     &  $1$     \\ \hline
0.01   &    $0.08$  &   $0.02$    &   $0.01$    &   $0.01$    &   $1$    \\ \hline
0.05   &    $0.165$   &  $0.03$     &    $0.015$   &   $0.02$    &  $1$     \\ \hline
0.1    &   $0.26$   &   $0.045$    &   $0.025$    &   $1$    &  $1$     \\ \hline
\end{tabular}
\caption{Resultados experimentales de la capacidad de la red de Hopfield para distintas correlaciones (indicada entre paréntesis)}
\label{tab:correlaciones}
\end{table}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_1.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_2.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_3.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_4.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\linewidth]{C:/Users/q/Documents/GitHub/Redes-neuronales/latex tp1/imgs/ej2_2_5.png}
...
La capacidad teórica y la obtenida experimentalmente difieren por un error relativo porcentual máximo de $2.7 \%$, razón por la cual se consideran prácticamente coincidentes. Algunas posibles razones detrás de la diferencia son:
\begin{itemize}
\item La capacidad teórica se calculó con la suposición de que la cantidad de neuronas es elevada, y puede que 200 no sea suficiente como para determinar esos decimales faltantes.
\item Los resultados mostrados se calculan en base a un promediado de los resultados de múltiples redes. Es posible que un aumento en la cantidad de redes promediadas resulte en más cercanía al valor real. 

Ahora bien, respecto a la capacidad en función de la correlación, se observa que capacidad disminuye con la correlación hasta que la correlación es unitaria y entonces la capacidad es ``perfecta''. Sucede que, a medida que la semejanza entre patrones aumenta, también aumenta su cercanía en la función energética (las cuencas se van acercando). Cuando las cuencas se superponen lo suficiente, el estado estable final va a ser uno diferente a los originalmente enseñados. Esto se puede pensar como que la red se confunde los patrones porque son todos similares, y converge a uno que encarna una mezcla de todos ellos. Existe un umbral de probabilidad de error admisible para el cual todos los patrones se parecen lo suficiente al patrón estable, causando que la capacidad aumente. 
Asimismo, la correlación unitaria implica que todos los patrones son idénticos, por lo que siempre se va a tener memoria perfecta. 
\end{itemize}
